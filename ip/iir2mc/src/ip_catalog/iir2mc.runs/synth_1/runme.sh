...
HD_PWD='/xilinxworks/sysgen/notch_panda/netlist/ip/iir2mc/src/ip_catalog/iir2mc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iir2mc_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iir2mc_bd_wrapper.tcl
